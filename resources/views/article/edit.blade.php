...
<div class="container">
    ...
    <form action="{{ route('article.update',$article->id)}}" method="POST">
        ...
        <div class="form-group">
            ...
            <input class="form-control" id="title" name="title" type="text" value="{{ $article->title }}" autocomplete="off" maxlength="100" required>
            <small class="form-text text-muted">※ 最大100文字</small>
        </div>
        <!-- 本文 -->
        <div class="form-group">
            <label for="body">本文 <small><span class="badge badge-danger">必須</span></small></label>
            <textarea class="form-control" id="body" name="body" rows="10" maxlength="1000" required>{{ $article->body }}</textarea>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-5">
                ...
                <input id="posted_at" name="posted_at" type="datetime-local" class="form-control" value="{{ ($article->posted_at) ? $article->posted_at->format('Y-m-d\TH:i') : '' }}" placeholder="年/月/日 [時:分]">
            </div>
        </div>
        <!-- 公開フラグ -->
        <div class="form-group">
